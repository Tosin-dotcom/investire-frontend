...
export default function Home() {
  ...
  return (
      <>
        <Head>
          <title>Register | Investire</title>
          <meta name="description" content="Create your Investire account to start your financial journey"/>
        </Head>
        ...
        <div className="h-screen flex flex-col md:flex-row bg-gray-800">
          ...
          <div className="hidden md:block md:w-1/2 relative overflow-hidden text-color">
            ...
            <div className="absolute bottom-10 left-10 right-10 z-10">
              <h2 className="text-3xl font-bold mb-3 font-[DM Sans]">AI-Powered Financial Platform</h2>
              <p className="text-xl opacity-90 font-[DM Sans]">Smart investments. Real-time data. Better decisions.</p>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center p-4 md:p-10 bg-gradient-to-br from-gray-900 to-gray-800">
            <div className="w-full max-w-md bg-white p-6 rounded-lg shadow-lg">
              <div className="text-center mb-4">
                ...
                <p className="text-gray-600 mt-2">Join Investire today</p>
              </div>
